...
<ul>
<li><code>npm install --prefix /path/to/dir</code> - Runs npm commands in a different directory without changing the current working directory</li>
<li><code>npm install --global</code> - Installs packages globally (shorthand: <code>-g</code>)</li>
<li><code>npm install --save-dev</code> - Saves to devDependencies (shorthand: <code>-D</code>)</li>
</ul>
<p>Any configuration option documented in the <a href="#config-settings">Config Settings</a> section below can be set via command line flags using <code>--option-name value</code> syntax.</p>
...
<p>This is the location of the "node-gyp" bin. By default it uses one that
ships with npm itself.</p>
<p>You can use this config to specify your own "node-gyp" to run when it is
required to build a package.</p>
...
<p>This config cannot be used with: <code>save-optional</code>, <code>save-peer</code>, <code>save-prod</code></p>
...
<p>This config cannot be used with: <code>save-dev</code>, <code>save-optional</code>, <code>save-prod</code></p>
...
<p>This config cannot be used with: <code>save-dev</code>, <code>save-optional</code>, <code>save-peer</code></p>
