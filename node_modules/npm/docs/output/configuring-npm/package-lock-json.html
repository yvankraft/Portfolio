...
<ul>
<li>
<p>version: a specifier that varies depending on the nature of the package, and is usable in fetching a new copy of it.
Note that for peer dependencies that are not installed, or optional dependencies that are not installed, this field may be omitted.</p>
<ul>
...
<p><strong>Note:</strong> The <code>version</code> field may be omitted for certain types of dependencies, such as optional peer dependencies that are not installed. In these cases, only metadata fields like <code>dev</code>, <code>optional</code>, and <code>peer</code> will be present.</p>
</li>
<li>
