.TH "PACKAGE-LOCK.JSON" "5" "February 2026" "NPM@11.10.0" ""
.SH "NAME"
...
.IP \(bu 4
cpu: An array of CPU architectures this package is compatible with, as specified in \fBpackage.json\fR. This field is included when the package specifies CPU restrictions.
.IP \(bu 4
funding: Funding information for the package, as specified in \fBpackage.json\fR. This field contains details about how to support the package maintainers.
.RE 0
...
.P
\fBNote:\fR The \fBversion\fR field may be omitted for certain types of dependencies, such as optional peer dependencies that are not installed. In these cases, only metadata fields like \fBdev\fR, \fBoptional\fR, and \fBpeer\fR will be present.
.IP \(bu 4
