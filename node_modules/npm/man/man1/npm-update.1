.TH "NPM-UPDATE" "1" "February 2026" "NPM@11.10.0" ""
.SH "NAME"
...
.SS "Description"
.P
This command will update all the packages listed to the latest version (specified by the \fB\[rs]fBtag\[rs]fR config\fR \fI\(la/using-npm/config#tag\(ra\fR), respecting the semver constraints of both your package and its dependencies (if they also require the same package).
.P
