.TH "NPM-PKG" "1" "February 2026" "NPM@11.10.0" ""
.SH "NAME"
...
.P
You can set/get/delete items across your configured workspaces by using the \fB\[rs]fBworkspace\[rs]fR\fR \fI\(la/using-npm/config#workspace\(ra\fR or \fB\[rs]fBworkspaces\[rs]fR\fR \fI\(la/using-npm/config#workspaces\(ra\fR config options.
.P
