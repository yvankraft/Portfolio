.TH "NPM-INIT" "1" "February 2026" "NPM@11.10.0" ""
.SH "NAME"
...
.P
Any additional options will be passed directly to the command, so \fBnpm init foo -- --hello\fR will map to \fBnpm exec -- create-foo --hello\fR.
.P
