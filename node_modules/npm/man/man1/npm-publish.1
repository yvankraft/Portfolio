.TH "NPM-PUBLISH" "1" "February 2026" "NPM@11.10.0" ""
.SH "NAME"
...
.IP \(bu 4
If there is a "files" list in \fB\[rs]fBpackage.json\[rs]fR\fR \fI\(la/configuring-npm/package-json\(ra\fR, then only the files specified will be included. (If directories are specified, then they will be walked recursively and their contents included, subject to the same ignore rules.)
.IP \(bu 4
...
.P
See \fB\[rs]fBpackage.json\[rs]fR\fR \fI\(la/configuring-npm/package-json\(ra\fR for more info on what can and can't be ignored.
.SS "Configuration"
.SS "\fBtag\fR"
.RS 0
.IP \(bu 4
