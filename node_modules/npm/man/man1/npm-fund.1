.TH "NPM-FUND" "1" "February 2026" "NPM@11.10.0" ""
.SH "NAME"
...
.P
It's possible to filter the results to only include a single workspace and its dependencies using the \fB\[rs]fBworkspace\[rs]fR config\fR \fI\(la/using-npm/config#workspace\(ra\fR option.
.SS "Example:"
.P
