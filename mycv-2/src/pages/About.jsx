...
const About = () => {
  ...
  useGSAP(() => {
    ...
    gsap.fromTo(
      "#box3",
      { duration: 2, ease: "linear", x: 0 },
      { x: 800, duration: 2, ease: "linear", repeat: -1, yoyo: true },
    );
    timeline.to("#box4", {
      x: 200,
      duration: 2,
  ...
  return (
    <div className=" bg-slate-200 p-4">
      ...
      >
        ...
        <div
          id="box1"
          className="bg-slate-800 h-48 w-48 rounded-3xl mt-10"
        ></div>
        <div id="box2" className="bg-white h-48 w-48 rounded-3xl"></div>
        <div id="box3" className="bg-green-500 h-48 w-48 rounded-3xl"></div>
        <div
          id="box4"
          className="text-white bg-yellow-500 h-48 w-48 p-8 mt-4 flex items-center justify-center"
        >
          timeline.box
        </div>
        <button
        ...
        <section ref={scrollRef}>
          ...
          <div
            id="box5"
            className="text-white bg-purple-500 h-48 w-48 p-8 mt-4 flex items-center justify-center"
          >
            Scrolltriger
          </div>
          <div
